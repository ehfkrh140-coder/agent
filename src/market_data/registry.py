...
from src.market_data.adapters.spot_futures_basis import BinanceSpotFuturesBasisAdapter, BybitSpotFuturesBasisAdapter
...
def build_adapter(adapter_id: str, config: dict[str, Any] | None = None) -> MarketDataAdapter:
    ...
    if adapter_type == "bybit_spot_futures_basis":
        return BybitSpotFuturesBasisAdapter(adapter_id, config=adapter_config)
